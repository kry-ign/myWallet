 ...
 */
final class Version20210224132655 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id_id INT DEFAULT NULL, product_name VARCHAR(15) NOT NULL, categry_id VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_D34A04AD9777D11E (category_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
